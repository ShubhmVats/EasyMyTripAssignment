package com.example.easymytripassignment.services
...
import com.example.easymytripassignment.other.Constants.LOCATION_UPDATE_INTERVAL
import com.example.easymytripassignment.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.easymytripassignment.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.easymytripassignment.other.Constants.NOTIFICATION_ID
import com.example.easymytripassignment.other.Constants.TIMER_UPDATE_VAL
import com.example.easymytripassignment.other.TrackingUtility
import com.example.easymytripassignment.ui.MainActivity
...
serviceKilled = true
   ...
   private var isTimerEnables =false
    private var lapTime =0L
    private var timeRun = 0L
    private var timeStarted = 0L
    private var lastSecondTiimeStamp = 0L
    ...
    private fun startTimer(){
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!){
                ...
                if (timeRunInMillis.value!! >= lastSecondTiimeStamp + 1000L){
                    timeRunInSeconds.postValue(timeRunInSeconds.value!! + 1)
                    lastSecondTiimeStamp += 1000L
                }
                delay(TIMER_UPDATE_VAL)
            }
            timeRun += lapTime
        }
    }
